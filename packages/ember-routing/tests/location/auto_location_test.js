...
QUnit.test("getHistoryPath() should return a normalized, HistoryLocation-supported path", function() {
  ...
  equal(getHistoryPath('/base/app/', browserLocation), '/base/app/about?foo=bar#foo', 'URLs already in HistoryLocation form should come out the same with baseURL');
  ...
  equal(getHistoryPath('/base/app/', browserLocation), '/base/app/about?foo=bar#foo', 'HashLocation formed URLs should be normalized with baseURL');
...
QUnit.test("getHashPath() should return a normalized, HashLocation-supported path", function() {
  ...
  equal(getHashPath('/app/', browserLocation), '/app/#/about?foo=bar#foo', 'URLs already in HashLocation form should come out the same');
  ...
  equal(getHashPath('/base/app/', browserLocation), '/base/app/#/about?foo=bar#foo', 'URLs already in HashLocation form should come out the same with baseURL');
  ...
  equal(getHashPath('/base/app/', browserLocation), '/base/app/#/about?foo=bar#foo', 'HistoryLocation formed URLs should be normalized with baseURL');
});
